...
public class SIRestPaths {
    ...
    // TODO collapse into one /game call with a parameter
    ...
    public static final String STATS_GAME_TIMESERIES = "/stats/game-timeseries";
    public static final String STATS_GAME_EVENTS = "/stats/game-events";
