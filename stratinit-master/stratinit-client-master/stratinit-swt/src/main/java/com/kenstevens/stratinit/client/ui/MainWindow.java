...
import com.kenstevens.stratinit.client.shell.*;
...
import com.kenstevens.stratinit.client.ui.tabs.*;
import com.kenstevens.stratinit.client.ui.window.WindowDirector;
import com.kenstevens.stratinit.client.ui.window.map.MapCanvasControl;
import com.kenstevens.stratinit.client.ui.window.map.MapImageManager;
	...
	private void setResizeListener(final Shell shell) {
		shell.addListener(SWT.Resize, new Listener() {
			...
			public void handleEvent(Event e) {
				...
				account.setSize(point.x, point.y);
			}
		});
		shell.addListener(SWT.Move, new Listener() {
			...
			public void handleEvent(Event e) {
				...
				account.setLocation(point.x, point.y);
			}
		});
