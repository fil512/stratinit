...
public class NationList implements Iterable<NationView> {
	private final Map<Integer, NationView> idMap = new Hashtable<Integer, NationView>();
	private final Map<String, NationView> nameMap = new Hashtable<String, NationView>();
